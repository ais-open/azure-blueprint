...
function Set-TargetResource
{
    ...
    if ($LogPath -and $FilePath)
    {
         ...
         Set-SQLStartupParameters -StartupParameters "-dF:\DATA\master.mdf,-eF:\LOG\ERRORLOG,-lF:\LOG\mastlog.ldf"
...
function Move-SystemDatabaseFile([string]$FilePath, [string]$LogPath, [PSCredential]$ServiceCredential )
{
    ...
    if (Test-Path "C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\")
    {
     ...
     Rename-Item -Path "C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\MSDBLog.ldf" -NewName "msdbLog.ldf"
...
function Set-SQLStartupParameters
{
    ...
    foreach($i in $instances){
        ...
        $smowmi = New-Object Microsoft.SqlServer.Management.Smo.Wmi.ManagedComputer "sqlserver-0"
        $smowmi
