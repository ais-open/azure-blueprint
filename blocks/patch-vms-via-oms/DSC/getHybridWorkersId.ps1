Configuration getHybridWorkersId
{
    ...
    {    
        ...
        Script CreateAutomationAccountVeriableWithHybridWorkerName
        {
            SetScript = 
            { 
                ...
                $AzureAuthCreds = $using:AzureAuthCreds
               ...
               if($SubscriptionId)
                ...
                try{
                    ...
                    $_id = New-Guid
                    $runBookName = $using:MachineName + "_" + $_id                    
            ...
            GetScript = { @{ Result = "CreateAutomationAccountVeriableWithHybridWorkerName"} }            
        }
...
<##Start-DscConfiguration .\ -ComputerName localhost -Wait -Verbose
...
getHybridWorkersId -OutputPath C:\DSC
